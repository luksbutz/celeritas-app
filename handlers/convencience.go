...
func (h *Handlers) render(w http.ResponseWriter, r *http.Request, tmp string, variables, data interface{}) error {
	return h.App.Render.Page(w, r, tmp, variables, data)
}
...
func (h *Handlers) sessionPop(ctx context.Context, key string) interface{} {
	return h.App.Session.Pop(ctx, key)
}
